...
def affineTransformation(images, template):
    ...
    for image in images:
        ...
        points2 = np.float32([[74, 63], [245, 63], [245, 318]])
...
img = cv2.imread("Data/DragonBaby/img/0001.jpg", 0)
template = img[63:318, 74:245]
# print(template[template.shape[0],template.shape[1]])
# cv2.imshow("template", template)
# img = cv2.rectangle(img, (74, 63), (245, 318), (255, 0, 0), 2)
